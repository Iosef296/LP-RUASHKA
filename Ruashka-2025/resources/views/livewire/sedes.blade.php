    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <div class="flex items-center gap-3 mb-2">
                    ...
                    <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Sedes</h1>
                </div>
                <p class="text-gray-600 dark:text-gray-400 ml-12">Gestión de sedes de la empresa</p>
            </div>
            <a href="{{ route('sede.create') }}" class="bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 text-white font-medium px-6 py-3 rounded-lg flex items-center gap-2 transition-colors shadow-sm">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 transition-colors">
            ...
            <div class="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
                <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Listado de Sedes</h2>
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Gestiona todas las sedes</p>
            </div>
            ...
            @if(isset($sedes) && count($sedes) > 0)
                ...
                <div class="px-6 py-4 bg-gray-50 dark:bg-gray-900/50 border-b border-gray-200 dark:border-gray-700">
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-2">
                            <span class="text-xs font-semibold text-indigo-600 dark:text-indigo-400 uppercase tracking-wider">Ciudad</span>
                        </div>
                        <div class="col-span-2">
                            <span class="text-xs font-semibold text-indigo-600 dark:text-indigo-400 uppercase tracking-wider">Tipo</span>
                        </div>
                        <div class="col-span-2">
                            <span class="text-xs font-semibold text-indigo-600 dark:text-indigo-400 uppercase tracking-wider">Encargado</span>
                        </div>
                        <div class="col-span-1">
                ...
                <div class="divide-y divide-gray-200 dark:divide-gray-700">
                    @foreach($sedes as $sede)
                        <div class="transition-colors">
                            <!-- Fila Normal -->
                            <div class="px-6 py-4 hover:bg-gray-50 dark:hover:bg-gray-700/50" wire:key="sede-{{ $sede->id }}">
                                <div class="grid grid-cols-12 gap-4 items-center">
                                    <div class="col-span-1">
                                        <span class="text-sm font-medium text-gray-900 dark:text-gray-100">{{ $sede->codigo }}</span>
                                    </div>

                                    <div class="col-span-2">
                                        <span class="text-sm text-gray-900 dark:text-gray-100">{{ $sede->nombre }}</span>
                                    </div>

                                    <div class="col-span-2">
                                        <span class="text-sm text-gray-600 dark:text-gray-400">{{ $sede->ciudad }}</span>
                                    </div>

                                    <div class="col-span-2">
                                        <span class="text-sm text-gray-900 dark:text-gray-100 capitalize">{{ $sede->tipo }}</span>
                                    </div>

                                    <div class="col-span-2">
                                        <span class="text-sm text-gray-600 dark:text-gray-400">{{ $sede->encargado ?? 'Sin asignar' }}</span>
                                    </div>
                                    ...
                                    <div class="col-span-2 flex items-center gap-2">
                                        ...
                                        <button wire:click="editSede({{ $sede->id }})"
                                        ...
                                        <button wire:click="deleteSede({{ $sede->id }})"
                                                wire:confirm="¿Estás seguro de eliminar esta sede?"
                            ...
                            @if($editingSedeId == $sede->id)
                                <div class="px-6 py-6 bg-indigo-50 dark:bg-indigo-950/30 border-t border-b border-indigo-200 dark:border-indigo-800">
                                    <div class="flex items-center justify-between mb-4">
                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">✏️ Editando: {{ $sede->nombre }}</h3>
                                    ...
                                    <form wire:submit.prevent="updateSede" class="space-y-6">
                                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" wire:model="editForm.ciudad" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white bg-white dark:bg-gray-700">
                                            </div>
                                            <div>
                                                <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Tipo</label>
                                                <select wire:model="editForm.tipo" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white bg-white dark:bg-gray-700">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" wire:model="editForm.encargado" class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-gray-900 dark:text-white bg-white dark:bg-gray-700">
                                            </div>
                                            <div>
                ...
                <div class="px-6 py-4 bg-gray-50 dark:bg-gray-900/50 border-t border-gray-200 dark:border-gray-700">
                    <p class="text-sm text-gray-600 dark:text-gray-400">
                        Total de sedes: <span class="font-semibold text-gray-900 dark:text-white">{{ count($sedes) }}</span>
                    </p>
                </div>
            ...
            @else
                ...
                <div class="px-6 py-20 text-center">
                    ...
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-white mb-2">No hay sedes registradas</h3>
                    <p class="text-gray-600 dark:text-gray-400 mb-6">Agrega tu primera sede para comenzar</p>
                    <a href="{{ route('sede.create') }}" class="bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 text-white font-medium px-6 py-3 rounded-lg inline-flex items-center gap-2 transition-colors shadow-sm">
