...
<body>
    <x-layouts.app :title="__('Nuevo Proveedor')"> <div class="py-8"> <div class="mx-auto max-w-4xl sm:px-6 lg:px-8">
...
```
        ...
        <div class="overflow-hidden rounded-2xl bg-white shadow-2xl dark:bg-gray-800">
            ...
            <div class="border-b border-gray-200 bg-gradient-to-r from-indigo-100 to-purple-100 px-6 py-4 dark:border-gray-700 dark:from-gray-700 dark:to-gray-800">
            ...
            <form action="{{ route('proveedores.store') }}" method="POST" class="p-6">
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" 
                               ...
                               id="Proveedor_Rubro"
                               value="{{ old('Proveedor_Rubro') }}"
                               placeholder="Ej: Textiles, Lanas, Insumos"
                               maxlength="50"
                    ...
                    <div>
                        ...
                        <textarea name="Proveedor_Direccion" 
                                  ...
                                  required>{{ old('Proveedor_Direccion') }}</textarea>
                ...
                <div class="mt-8 flex items-center justify-end gap-4 border-t border-gray-200 pt-6 dark:border-gray-700">
                    ...
                    <button type="submit" 
                            class="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-indigo-600 to-purple-700 px-6 py-3 font-semibold text-white shadow-lg transition-all hover:scale-105 hover:shadow-xl">
