...
<body>
    <x-layouts.app :title="__('Detalle de Proyección')">
    <div class="py-8">
            ...
            <div class="mb-6 flex items-center justify-between">
                <div>
                    <h2 class="text-3xl font-bold text-gray-800 dark:text-gray-100">
                        📊 Proyección #{{ $proyeccion->Proyec_ID }}
                    </h2>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        Detalles de la proyección de producción
                    </p>
                </div>
                ...
                <div class="p-6">
                    <div class="space-y-6">
                        ...
                        <div class="flex items-start gap-4 rounded-xl bg-gray-50 p-4 dark:bg-gray-700">
                            ...
                            <div class="flex-1">
                                <p class="text-sm font-medium text-gray-600 dark:text-gray-400">ID de Proyección</p>
                                <p class="mt-1 text-2xl font-bold text-gray-900 dark:text-gray-100">#{{ $proyeccion->Proyec_ID }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 rounded-xl bg-gray-50 p-4 dark:bg-gray-700">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-lg font-bold text-gray-900 dark:text-gray-100">{{ $proyeccion->Proyec_Nombre }}</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start gap-4 rounded-xl bg-gray-50 p-4 dark:bg-gray-700">
                            ...
                            <div class="flex-1">
                                ...
                                <span class="mt-1 inline-flex items-center gap-1 rounded-full bg-purple-100 px-3 py-1 text-sm font-semibold text-purple-800 dark:bg-purple-900 dark:text-purple-200">
                        ...
                        <div class="flex items-start gap-4 rounded-xl bg-gray-50 p-4 dark:bg-gray-700">
                            ...
                            <div class="flex-1">
                                ...
                                <p class="mt-1 text-gray-900 dark:text-gray-100">{{ $proyeccion->Proyec_Descripcion }}</p>
                            </div>
                        </div>
